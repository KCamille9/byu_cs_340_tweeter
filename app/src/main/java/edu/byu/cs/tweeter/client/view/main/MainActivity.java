...
//            Status newStatus = new Status(post, Cache.getInstance().getCurrUser(), getFormattedDateTime(), parseURLs(post), parseMentions(post));
            ...
            presenter.executePostStatusTask(post);
    ...
    @Override
    public void setIsNotFollowerCase() {
        followButton.setText(R.string.follow);
        followButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
    }

    @Override
    public void followObserverSuccess() {
        updateSelectedUserFollowingAndFollowers();
    ...
    @Override
    public void unFollowObserverSuccess() {
        updateSelectedUserFollowingAndFollowers();
    ...
    public void postStatusSuccess() {
        postingToast.cancel();
//        displayErrorMessage("Successfully Posted!");
